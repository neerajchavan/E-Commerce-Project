 ...
 * Generated at: 2020-10-24 04:12:13 UTC
...
public final class Registration_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/Components/navbar.jsp", Long.valueOf(1603512714000L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	session.removeAttribute("error_message");
      ...
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" id=\"name\" placeholder=\"Enter here\"\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"name\">\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"email\">Email</label> <input type=\"email\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" id=\"email\" placeholder=\"Enter here\"\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"email\">\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"pass\">Password</label> <input type=\"password\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" id=\"pass\" placeholder=\"Enter here\"\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"pass\">\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"mobno\">Mobile no</label> <input type=\"number\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" id=\"mobno\" placeholder=\"Enter here\"\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"mobno\">\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"address\">Address</label>\n");
      out.write("\t\t\t\t\t\t\t\t<textarea class=\"form-control\" id=\"addr\"\n");
      out.write("\t\t\t\t\t\t\t\t\tplaceholder=\"Enter your address\" style=\"height: 160px\"\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"addr\"></textarea>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<div class=\"container text-center\">\n");
      out.write("\t\t\t\t\t\t\t\t<button class=\"btn btn-lg btn-outline-success\" type=\"submit\">Register</button>\n");
      out.write("\t\t\t\t\t\t\t\t<button class=\"btn btn-lg btn-outline-warning\" type=\"reset\">Clear</button>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</form>\n");
      out.write("\n");
      out.write("\t\t\t\t\t</div>\n");
